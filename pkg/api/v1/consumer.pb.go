...
const (
	// Unknown means we don't know what state the Consumer Engine is in
	EnginePhase_PHASE_UNKNOWN EnginePhase = 0
	// Preparing means the Consumer Engine hasn't started yet and isn't consuming resources in the system
	EnginePhase_PHASE_PREPARING EnginePhase = 1
	// Starting means the Consumer Engine has been scheduled and is waiting to run. Things that might prevent it
	// from running already are pod scheduling, image pull or container startup.
	EnginePhase_PHASE_STARTING EnginePhase = 2
	// Running means the Consumer Consumer Engine is actually running and doing work.
	EnginePhase_PHASE_RUNNING EnginePhase = 3
	// Done means the Consumer Engine has run and is finished
	EnginePhase_PHASE_DONE EnginePhase = 4
	// Cleaning means the Consumer Engine is in post-run cleanup
	EnginePhase_PHASE_CLEANUP EnginePhase = 5
	// Waiting means the Consumer Engine is waiting for its start time or some other condition to be met
...
var file_consumer_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x12, 0x4c,
	...
	0x69, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x2d, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x2f,
...
var file_consumer_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_consumer_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
...
var file_consumer_proto_depIdxs = []int32{
	...
	5,  // 27: v1.DigitalConsumer.StartLocalEngine:input_type -> v1.StartLocalEngineRequest
	8,  // 28: v1.DigitalConsumer.StartFromPreviousEngine:input_type -> v1.StartFromPreviousEngineRequest
	7,  // 29: v1.DigitalConsumer.StartEngine:input_type -> v1.StartEngineRequest
	9,  // 30: v1.DigitalConsumer.ListEngines:input_type -> v1.ListEnginesRequest
	14, // 31: v1.DigitalConsumer.Subscribe:input_type -> v1.SubscribeRequest
	16, // 32: v1.DigitalConsumer.GetEngine:input_type -> v1.GetEngineRequest
	18, // 33: v1.DigitalConsumer.Listen:input_type -> v1.ListenRequest
	27, // 34: v1.DigitalConsumer.StopEngine:input_type -> v1.StopEngineRequest
	6,  // 35: v1.DigitalConsumer.StartLocalEngine:output_type -> v1.StartEngineResponse
	6,  // 36: v1.DigitalConsumer.StartFromPreviousEngine:output_type -> v1.StartEngineResponse
	6,  // 37: v1.DigitalConsumer.StartEngine:output_type -> v1.StartEngineResponse
	13, // 38: v1.DigitalConsumer.ListEngines:output_type -> v1.ListEnginesResponse
	15, // 39: v1.DigitalConsumer.Subscribe:output_type -> v1.SubscribeResponse
	17, // 40: v1.DigitalConsumer.GetEngine:output_type -> v1.GetEngineResponse
	19, // 41: v1.DigitalConsumer.Listen:output_type -> v1.ListenResponse
	28, // 42: v1.DigitalConsumer.StopEngine:output_type -> v1.StopEngineResponse
...
func file_consumer_proto_init() {
	...
	file_consumer_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_consumer_proto_msgTypes[14].OneofWrappers = []interface{}{
